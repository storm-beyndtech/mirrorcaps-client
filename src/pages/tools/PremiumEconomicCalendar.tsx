    ...
    <section className="relative py-20 lg:py-32 bg-gradient-to-b from-slate-950 via-blue-950/20 to-slate-950">
      ...
      >
        ...
        <div className="relative z-10 text-center px-6">
          <h1 className="max-w-3xl text-8xl font-bold text-white mb-6 tracking-tight">
            Professional Economic Calendar
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto font-medium">
            Catch all the major market moves on news!
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-30 pb-20">
        ...
        <div className="text-center mb-20">
          <h2 className="text-4xl lg:text-6xl font-bold text-white mb-8 leading-tight">
            START TRADING NEWS LIKE THE
            <span className="block">PROS!</span>
          </h2>

          <p className="text-lg text-slate-300 max-w-4xl mx-auto leading-relaxed">
            With real-time, actionable macro-economic data, you can easily
            monitor, anticipate and act on market-moving events. To gain access
            to live market events, all you need to do is open a live account and
            fund it with $500 or more. Don't miss a thing and start trading
            news-driven volatility with our premium Economic Calendar!
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-300 leading-relaxed">
              Act in an instant with actionable, real-time economic data and act
              on market moving events from more than 30 countries across the
              globe.
            </p>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative">
              <img
                src="https://protradercopy.com/wp-content/themes/ProTrader-Copy/images/professional-economic-calendar-row2-img1.webp"
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <div className="order-2 lg:order-1 relative group">
            ...
            <div className="relative">
              <img
                src="https://protradercopy.com/wp-content/themes/ProTrader-Copy/images/professional-economic-calendar-row2-img2.webp"
          ...
          <div className="order-1 lg:order-2 space-y-6">
            ...
            <p className="text-lg text-slate-300 leading-relaxed">
              Our premium Economic Calendar knows your timezone, so all news and
              announcement times are displayed according to where you are so you
              won't miss a move.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-300 leading-relaxed">
              Whether you prefer to trade NFP or Central Bank announcements, you
              can choose the news that is important to you by filtering news by
              country and impact.
            </p>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative">
              <img
                src="https://protradercopy.com/wp-content/themes/ProTrader-Copy/images/professional-economic-calendar-row2-img3.webp"
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <div className="order-2 lg:order-1 relative group">
            ...
            <div className="relative">
              <img
                src="https://protradercopy.com/wp-content/themes/ProTrader-Copy/images/professional-economic-calendar-row2-img4.webp"
          ...
          <div className="order-1 lg:order-2 space-y-6">
            ...
            <p className="text-lg text-slate-300 leading-relaxed">
              Take a look at how similar events and past data previously played
              out with news announcements overlaid on on a FX price chart!
            </p>
          </div>
        </div>
